...
lista=[["corpus_train%i.txt"%i,
"corpus_test%i.txt"%(i),
"vectoresSet%i_g%i.pkl"%(i,n),
"vocabulario%i_g%i.pkl"%(i,n)] for i in range(5)
    ]

# lista=[
#     # ["corpus_train0.txt","corpus_test0.txt","vectoresSet0_g%i.pkl"%n],
#     # ["corpus_train1.txt","corpus_test1.txt","vectoresSet1_g%i.pkl"%n],
#     # ["corpus_train2.txt","corpus_test2.txt","vectoresSet2_g%i.pkl"%n],
#     # ["corpus_train3.txt","corpus_test3.txt","vectoresSet3_g%i.pkl"%n],
#     ["corpus_train4.txt","corpus_test4.txt","vectoresSet4_g%i.pkl"%n]
#     ]
for docs in lista:
